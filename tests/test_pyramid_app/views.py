...
class TestsDbsession(Handler):
    ...
    @view_config(route_name="test:dbSession:callbacks", renderer="templates/test_results.mako")
...
class TestsDbsessionReader(Handler):
    ...
    def test_query_status(self):
        ...
        if 'writer' in self.request.dbSession.__dict__:
            raise ValueError("`writer` should not memoize into `self.request.dbSession`")
        return {}
